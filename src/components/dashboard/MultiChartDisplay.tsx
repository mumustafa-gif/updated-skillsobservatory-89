    ...
    return {
      ...
      tooltip: {
        ...
        formatter: function(params: any) {
          ...
          if (chartOption.series?.[0]?.type === 'heatmap') {
          ...
          if (chartOption.series?.[0]?.type === 'radar') {
            if (Array.isArray(params)) {
          ...
          if (chartOption.series?.[0]?.type === 'scatter') {
            if (Array.isArray(params)) {
              const param = params[0];
              const xAxisName = chartOption.xAxis?.name || 'X Axis';
              const yAxisName = chartOption.yAxis?.name || 'Y Axis';
        ...
        ? chartOption.xAxis.map(axis => ({
            ...
            axisLabel: {
              ...
              formatter: axis.axisLabel?.formatter || function(value: any) {
                if (typeof value === 'string' && value.length > (isMobile ? 6 : 10)) {
                  return value.substring(0, isMobile ? 6 : 10) + '...';
                }
                return value;
              },
              ...axis.axisLabel
